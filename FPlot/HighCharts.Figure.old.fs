...
module Figure =
    ...
    type IFigureItem =
        abstract GetIndexes : unit -> int list
    ...
    let addPath cur preFix =
        if String.IsNullOrEmpty(preFix) then
            cur
        else
            sprintf "%s.%s" preFix cur
    ...
    type Figure_Series_Item_Name(parent:IFigureItem option) =
        ...
        interface IFigureItem with
            member this.GetIndexes() =
                parentItem
                |> Option.map (fun parent -> parent.GetIndexes())
                |> Option.defaultValue []
        ...
        member this.Set (o:string) =
            //update currentChartIndex ((this :> IFigureItem).ParentPath()) (sprintf "%s" (Figure_Series_Item_Name.ToJson o))
            update currentChartIndex ((this :> IFigureItem).GetIndexes()) (sprintf "{\\\"series\\\":[{\\\"name\\\":%s}]}" (Figure_Series_Item_Name.ToJson o))
    ...
    type Figure_Series_Item_Data_Item(parent:IFigureItem option) =
        ...
        interface IFigureItem with
            member this.GetIndexes() =
                parentItem
                |> Option.map (fun parent -> lastIndex::parent.GetIndexes())
        ...
        member this.Set (o:int) =
            update currentChartIndex ((this :> IFigureItem).GetIndexes()) (sprintf "%s" (Figure_Series_Item_Data_Item.ToJson o))
    ...
    type Figure_Series_Item_Data(parent:IFigureItem option) as this =
        ...
        member this.Set (o:int seq) =
            ...
            update currentChartIndex ((this :> IFigureItem).GetIndexes()) (sprintf "%s" (Figure_Series_Item_Data.ToJson o))
    ...
    type Figure_Series_Item(parent:IFigureItem option) =
        ...
        interface IFigureItem with
            member this.GetIndexes() =
                parentItem
                |> Option.map (fun parent -> (sprintf "series#%i" lastIndex)::parent.GetIndexes())
                |> Option.defaultValue [lastIndex]
        ...
        static member ToJson (o:{| name:string; data:int seq |}) =
            ...
            sprintf "{\\\"id\\\":##ID1##,\\\"name\\\":%s,\\\"data\\\":%s}" name data

        member this.Set (o:{| name:string; data:int seq |}) =
            update currentChartIndex ((this :> IFigureItem).GetIndexes()) (sprintf "{\\\"series\\\":{\\\"item\\\":%s}}" (Figure_Series_Item.ToJson o))
    ...
    type Figure_Series(parent:IFigureItem option) as this =
        ...
        member this.Set (o:{| name:string; data:int seq |} seq) =
            update currentChartIndex ((this :> IFigureItem).GetIndexes()) (sprintf "%s" (Figure_Series.ToJson o))
