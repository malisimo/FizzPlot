...
module Figure =
    ...
    ///<summary>Figure_PlotOptions_Pie_Center : <code> seq</code></summary>
    type Figure_PlotOptions_Pie_Center() =
        let item = Figure_PlotOptions_Pie_Center_Item()

        member this.Set (o: seq) =
            send "##JSON##"
    ...
    type Figure_Exporting() =
        ...
        member this.Set (o:{| type:string; url:string; printMaxWidth:int; scale:int; buttons: {| contextButton: {| className:string; menuClassName:string; symbol:string; titleKey:string; menuItems:string seq |} |}; menuItemDefinitions: {| viewFullscreen: {| textKey:string |}; printChart: {| textKey:string |}; separator: {| separator:bool |}; downloadPNG: {| textKey:string |}; downloadJPEG: {| textKey:string |}; downloadPDF: {| textKey:string |}; downloadSVG: {| textKey:string |} |} |}) =
            send "##JSON##"
    ...
    ///<summary>Figure_YAxis_Item : <code>{| gridLineColor:string; labels: {| style: {| color:string |} |}; lineColor:string; tickColor:string; tickWidth:int; title: {| style: {| color:string; fontWeight:string; fontSize:string; fontFamily:string |}; text:string |}; index:int |}</code></summary>
    type Figure_YAxis_Item() =
        ...
        member this.Set (o:{| gridLineColor:string; labels: {| style: {| color:string |} |}; lineColor:string; tickColor:string; tickWidth:int; title: {| style: {| color:string; fontWeight:string; fontSize:string; fontFamily:string |}; text:string |}; index:int |}) =
            send "##JSON##"

    ///<summary>Figure_YAxis : <code>{| gridLineColor:string; labels: {| style: {| color:string |} |}; lineColor:string; tickColor:string; tickWidth:int; title: {| style: {| color:string; fontWeight:string; fontSize:string; fontFamily:string |}; text:string |}; index:int |} seq</code></summary>
    type Figure_YAxis() =
        let item = Figure_YAxis_Item()

        member this.Set (o:{| gridLineColor:string; labels: {| style: {| color:string |} |}; lineColor:string; tickColor:string; tickWidth:int; title: {| style: {| color:string; fontWeight:string; fontSize:string; fontFamily:string |}; text:string |}; index:int |} seq) =
            send "##JSON##"
    ...
    type figure() =
        ...
        ///<summary>Figure_Global : <code>{| dummy:string |}</code></summary>
        member this.global = Figure_Global()
